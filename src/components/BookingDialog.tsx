...
import {Calendar, CarIcon, Clock, Mail, Phone, User} from "lucide-react";
...
import {formFieldSchema, type BookingFormValues} from "@/schemas/user.schema.ts";
...
export const BookingDialog = ({
    ...
    const isContactComplete =
        formFieldSchema.safeParse(contactValues).success;
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="!max-w-lg overflow-hidden p-0 rounded-lg border border-border bg-background shadow-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div>
                    ...
                    >
                        ...
                        <div className="space-y-3.5">
                            ...
                            <FieldGroup>
                                {/* fieldState is scoped to this one Controller instance —
                                    that's what data-invalid/aria-invalid/FieldError read from below. */}
                                <Controller
                                    name="fullName"
                                    control={control}
                        ...
                        <div className="pt-2">
                            ...
                            <p className="text-[0.60rem] text-muted-foreground text-center mt-3 font-medium italic">
                                No deposit needed. We will prepare this vehicle
                                for your arrival.
                            </p>
                        </div>
                    </form>
